...
AS
  ...
  BEGIN
    ...
    INSERT INTO dbo.WeatherPredictions (WP_CreatedTimeUTC, WP_PredictionDateUTC, WP_CreatorUserNodeID, WP_ZipCode, WP_TempLow, WP_TempHigh, WP_WeatherSourceID, WP_WeatherCode)
      VALUES (SYSUTCDATETIME(), @PredictionDateUTC, @CreatorNodeID, @ZipCode, @Low, @High, 1, @Code)
